...
function Main {
    ...
    Write-Host "  Tenant Admin 2: admin-2@example.com / Admin@123"
    Write-Host ""
    Write-Host "  $($Bright)Employee Login (Password: Employee@123):$($Reset)"
    Write-Host "  1. employee1@tenant1.com    - Money Loan (View Only)"
    Write-Host "  2. employee2@tenant1.com    - Money Loan (Manage) + BNPL (View)"

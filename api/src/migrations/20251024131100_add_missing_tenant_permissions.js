...
exports.up = async function(knex) {
  ...
  // Use a transaction to ensure all inserts complete
  ...
  console.log(`🎉 Migration completed: Added ${addedCount} missing tenant permissions`);
  console.log('ℹ️  Note: Role assignments will be handled in seed files');
};

              ...
              <div *ngIf="expandedGroups().has(item.label)" class="ml-4 space-y-0.5 border-l-2 border-gray-200 dark:border-gray-700 pl-2">
                <a
                  *ngFor="let child of item.children"
                  ...
                  class="flex items-center gap-2 rounded px-3 py-1.5 text-xs font-medium text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 transition"
                >

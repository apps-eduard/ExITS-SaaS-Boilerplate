...
export class LoginComponent {
  ...
  testAccounts = [
    ...
    { email: 'admin@acme.com', password: 'Admin@123', label: 'Tenant Admin - ACME Corporation', role: 'tenant' },
    { email: 'admin@techstart.com', password: 'Admin@123', label: 'Tenant Admin - TechStart Solutions', role: 'tenant' }
  ];

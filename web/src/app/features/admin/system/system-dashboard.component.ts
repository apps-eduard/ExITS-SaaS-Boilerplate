...
@Component({
  ...
  template: `
    <div class="p-6 space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <a
          *ngIf="canViewHealth()"
          ...
          class="group p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-blue-500 dark:hover:border-blue-400 hover:shadow-md transition-all"
        >
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400">View status</p>
            </div>
          </div>
        </a>
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400">Metrics & stats</p>
            </div>
          </div>
        </a>
        ...
        >
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center group-hover:scale-110 transition-transform">
              <svg class="w-5 h-5 text-gray-600 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            </div>
            <div>
              <p class="text-sm font-medium text-gray-900 dark:text-white">System Logs</p>
              <p class="text-xs text-gray-500 dark:text-gray-400">View logs</p>
            </div>
          </div>
        </a>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
          <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
            <h2 class="text-sm font-semibold text-gray-900 dark:text-white">System Information</h2>
          </div>
          <div class="p-4 space-y-3">
            ...
            <div class="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
              ...
              <span class="text-sm font-medium text-gray-900 dark:text-white">{{ systemInfo().platform }}</span>
            </div>
            <div class="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
              <span class="text-sm text-gray-600 dark:text-gray-400">Node Version</span>
              <span class="text-sm font-medium text-gray-900 dark:text-white">{{ systemInfo().nodeVersion }}</span>
            </div>
            <div class="flex items-center justify-between py-2">
              <span class="text-sm text-gray-600 dark:text-gray-400">Uptime</span>
              <span class="text-sm font-medium text-gray-900 dark:text-white">{{ formatUptime(systemInfo().uptime) }}</span>
            </div>
          </div>
        </div>
        ...
        <div class="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
          <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
            <h2 class="text-sm font-semibold text-gray-900 dark:text-white">Database Statistics</h2>
          </div>
          <div class="p-4 space-y-3">
            <div class="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
              <span class="text-sm text-gray-600 dark:text-gray-400">Total Users</span>
              <span class="text-sm font-medium text-gray-900 dark:text-white">{{ dbStats().totalUsers.toLocaleString() }}</span>
            </div>
            <div class="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
              <span class="text-sm text-gray-600 dark:text-gray-400">Total Tenants</span>
              <span class="text-sm font-medium text-gray-900 dark:text-white">{{ dbStats().totalTenants.toLocaleString() }}</span>
            </div>
            <div class="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
              <span class="text-sm text-gray-600 dark:text-gray-400">Total Roles</span>
              <span class="text-sm font-medium text-gray-900 dark:text-white">{{ dbStats().totalRoles.toLocaleString() }}</span>
            </div>
            <div class="flex items-center justify-between py-2">
              <span class="text-sm text-gray-600 dark:text-gray-400">Active Connections</span>
              <span class="text-sm font-medium text-gray-900 dark:text-white">{{ dbStats().activeConnections }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
        <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
          <h2 class="text-sm font-semibold text-gray-900 dark:text-white">Resource Usage</h2>
        </div>
        <div class="p-4 space-y-4">
          ...
          <div>
            <div class="flex items-center justify-between mb-2">
              ...
              <span class="text-sm font-semibold" [class]="getCpuColor()">{{ systemInfo().cpuUsage }}%</span>
            </div>
          ...
          <div>
            <div class="flex items-center justify-between mb-2">
              ...
              <span class="text-sm font-semibold" [class]="getMemoryColor()">{{ systemInfo().memoryUsage }}%</span>
            </div>
            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
              <div
                class="h-2 rounded-full transition-all duration-500"
          ...
          <div>
            <div class="flex items-center justify-between mb-2">
              ...
              <span class="text-sm font-semibold" [class]="getDiskColor()">{{ systemInfo().diskUsage }}%</span>
            </div>
            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
              <div
                class="h-2 rounded-full transition-all duration-500"
      ...
      <div class="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
        <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
          <h2 class="text-sm font-semibold text-gray-900 dark:text-white">Recent System Events</h2>
        </div>
        <div class="p-4">
          <div class="space-y-3">
            <div class="flex items-start gap-3 pb-3 border-b border-gray-100 dark:border-gray-700">
              ...
              <div class="flex-1 min-w-0">
                <p class="text-sm font-medium text-gray-900 dark:text-white">System Started</p>
                <p class="text-xs text-gray-500 dark:text-gray-400">{{ formatUptime(systemInfo().uptime) }} ago</p>
              </div>
            </div>
            <div class="flex items-start gap-3 pb-3 border-b border-gray-100 dark:border-gray-700">
              ...
              <div class="flex-1 min-w-0">
                <p class="text-sm font-medium text-gray-900 dark:text-white">Database Connected</p>
                <p class="text-xs text-gray-500 dark:text-gray-400">{{ dbStats().activeConnections }} active connections</p>
              </div>
            </div>
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1 min-w-0">
                <p class="text-sm font-medium text-gray-900 dark:text-white">Security Check Passed</p>
